...
SHIPMENT_SEED = [
    ...
    ("catl", "2026E", 160, 45, 115, 20, 105, 35),
    ("catl", "2026Q1", 35, None, None, None, None, None), ("catl", "2026Q2", 40, None, None, None, None, None),
    ("catl", "2026Q3", 42, None, None, None, None, None), ("catl", "2026Q4", 43, None, None, None, None, None),
    ("byd", "2022", 11, 8.8, 2.2, 1, 8, 2), ("byd", "2023", 23, 17.5, 5.5, 2, 18, 3),
    ("byd", "2024", 28, 22, 6, 3, 20, 5), ("byd", "2025", 65, 40, 25, 5, 50, 10),
    ("byd", "2026E", 85, 55, 30, 8, 65, 12),
    ("byd", "2026Q1", 18, None, None, None, None, None), ("byd", "2026Q2", 21, None, None, None, None, None),
    ("byd", "2026Q3", 23, None, None, None, None, None), ("byd", "2026Q4", 23, None, None, None, None, None),
    ...
    ("hb", "2026Q1", 14, None, None, None, None, None), ("hb", "2026Q2", 16, None, None, None, None, None),
    ("hb", "2026Q3", 17, None, None, None, None, None), ("hb", "2026Q4", 18, None, None, None, None, None),
    ...
    ("hc", "2026E", 95, 80, 15, 7, 75, 13),
    ("hc", "2026Q1", 20, None, None, None, None, None), ("hc", "2026Q2", 24, None, None, None, None, None),
    ("hc", "2026Q3", 25, None, None, None, None, None), ("hc", "2026Q4", 26, None, None, None, None, None),
    ("tesla", "2024", 33.65, 0, 33.65, 1.65, 25, 7), ("tesla", "2025", 46.7, 0, 46.7, 2, 35, 9.7),
    ("tesla", "2026E", 60, 0, 60, 3, 45, 12),
    ("tesla", "2026Q1", 13, None, None, None, None, None), ("tesla", "2026Q2", 15, None, None, None, None, None),
    ("tesla", "2026Q3", 16, None, None, None, None, None), ("tesla", "2026Q4", 16, None, None, None, None, None),
    ...
    ("tc", "2026E", 12, 8, 4, 1.5, 9, 1.5),
    ("tc", "2026Q1", 2.7, None, None, None, None, None), ("tc", "2026Q2", 3, None, None, None, None, None),
    ("tc", "2026Q3", 3.1, None, None, None, None, None), ("tc", "2026Q4", 3.2, None, None, None, None, None),
    ...
    ("deye", "2026E", 65, 12, 53, 45, 7, 13),
    ("deye", "2026Q1", 15, None, None, None, None, None), ("deye", "2026Q2", 16, None, None, None, None, None),
    ("deye", "2026Q3", 17, None, None, None, None, None), ("deye", "2026Q4", 17, None, None, None, None, None),
    ("sg", "2024", 1.5, 0.05, 1.45, 1.2, 0.1, 0.2), ("sg", "2025", 4.0, 0.04, 3.96, 3.2, 0.3, 0.5),
    ("sg", "2026E", 8, 0.1, 7.9, 6.4, 0.6, 1),
    ("sg", "2026Q1", 1.7, None, None, None, None, None), ("sg", "2026Q2", 2, None, None, None, None, None),
    ("sg", "2026Q3", 2.1, None, None, None, None, None), ("sg", "2026Q4", 2.2, None, None, None, None, None),
    ("flu", "2024", 9.0, 5.1, 3.9, 0, 7, 2), ("flu", "2025", 8.5, 4.7, 3.8, 0, 6.5, 2),
    ("flu", "2026E", 10, 5.5, 4.5, 0, 8, 2),
    ("flu", "2026Q1", 2.3, None, None, None, None, None), ("flu", "2026Q2", 2.5, None, None, None, None, None),
    ("flu", "2026Q3", 2.6, None, None, None, None, None), ("flu", "2026Q4", 2.6, None, None, None, None, None),
]
...
COST_SEED = [
    ...
    ("catl", "2026E", 0.350, 0.360, 26.0, 0.540, 33.0),
    ("byd", "2024", None, None, 15.0, None, 15.0), ("byd", "2025", None, None, 15.0, None, 15.0),
    ("byd", "2026E", None, None, 15.0, None, 15.0),
    ...
    ("hc", "2026E", 0.240, 0.270, 10.0, 0.540, 55.0),
    ("tesla", "2024", 0.62, 0.85, 27.1, 0.98, 36.7), ("tesla", "2025", 0.55, 0.75, 26.7, 0.88, 37.5),
    ("tesla", "2026E", 0.50, 0.70, 26.5, 0.82, 37.0),
    ...
    ("tc", "2026E", 0.400, 0.420, 2.0, 0.500, 16.0),
...
FINANCIAL_SEED = [
    ...
    ("catl", "2026E", 750.0, 26.5, 190.0, 25.3, 170, 185, 195, 200, 44, 47, 49, 50),
    ...
    ("byd", "2026E", 480.0, 15.0, None, None, 110, 120, 125, 125, None, None, None, None),
    ...
    ("hc", "2026E", 300.0, 17.0, 12.0, 4.0, 68, 74, 78, 80, 2.5, 3.0, 3.2, 3.3),
    ...
    ("tesla", "2026E", 420.0, 17.0, 70.0, 16.7, 95, 105, 108, 112, 16, 17.5, 18, 18.5),
    ...
    ("tc", "2026E", 40.0, 9.0, -3.0, -7.5, 9.5, 10, 10.5, 10, -0.8, -0.7, -0.75, -0.75),
    ...
    ("deye", "2026E", 140.0, 38.0, 36.0, 25.7, 33, 35, 36, 36, 8.5, 9, 9.2, 9.3),
    ...
    ("sg", "2026E", 120.0, 48.0, 38.0, 31.7, 27, 30, 31, 32, 8.5, 9.5, 9.8, 10.2),
    ("flu", "2024", 63.0, 12.0, -0.28, -0.44, 15, 16, 16, 16, -0.1, -0.05, -0.05, -0.08),
    ("flu", "2025", 59.5, 14.0, 0.50, 0.84, 14, 15, 15.5, 15, 0.1, 0.15, 0.15, 0.1),
    ("flu", "2026E", 62.0, 14.0, 1.2, 1.9, 14.5, 15.5, 16, 16, 0.25, 0.3, 0.35, 0.3),
]
...
INDUSTRY_SEED = [
    ...
    ("锂电池", "全球锂电池出货量", 1180, "GWh", "2026E", "全球"),
    ...
    ("储能", "系统成本", 0.34, "¥/Wh", "2026E", "全球"),
]

RANKING_SEED = [
    ("比亚迪", 25.2, 53.63, 68.0, 7.6, 5.2, 11.6, 0.8),
    ("Tesla", 33.65, 46.7, 55.0, 27.1, 3.5, 0, 3.1),
    ("阳光电源", 28, 42.95, 52.0, 8, 5, 13.5, 1.5),
    ("宁德时代", 33, 41.5, 50.0, 14.2, 3, 13.6, 2.2),
    ("中车株洲所", 14.6, 25.05, 32.0, 0, 0, 14.6, 0),
    ("华为", 6.6, 25.6, 33.0, 0, 2.4, 2.9, 1.3),
    ("海博思创", 12.1, 24, 65.0, 0, 0, 12.47, 0.03),
    ("远景能源", 8, 17.1, 22.0, 0.4, 0.5, 6.8, 0.3),
    ("海辰储能", 0, 10.3, 15.0, 4.7, 1.2, 3.3, 1.1),
    ("电工时代", 5.8, 9.8, 12.0, 0, 0, 5.8, 0),
    ("Fluence", 9, 8.5, 10.0, 5.1, 1.825, 0, 2.1),
    ("阿特斯", 6.5, 8.1, 10.5, 3.5, 0.2, 1.66, 1.14),
]
    ...
    with get_connection() as conn:
        ...
        if c.fetchone()["cnt"] == 0:
            for item in RANKING_SEED:
                ph = "(%s,%s,%s,%s,%s,%s,%s,%s)" if USE_PG else "(?,?,?,?,?,?,?,?)"
                c.execute(f"INSERT INTO ranking_data (company_name,year_2024,year_2025,year_2026,americas,emea,china,asia_pacific) VALUES {ph}", item)
